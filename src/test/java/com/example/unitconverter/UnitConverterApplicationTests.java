...
class UnitConverterApplicationTests {
    ...
    void testLengthUnits() {
        ...
        Assertions.assertEquals(63360.0, ManageUnits.convert(length, LengthUnits.MILE.toString(), LengthUnits.INCH.toString(), 1.0));
    }
    ...
    void testWeightUnits() {
        ...
        Assertions.assertEquals(2.204623, ManageUnits.convert(weight, WeightUnits.KILOGRAM.toString(), WeightUnits.POUND.toString(), 1.0));
        Assertions.assertEquals(35.273962, ManageUnits.convert(weight, WeightUnits.KILOGRAM.toString(), WeightUnits.OUNCE.toString(), 1.0));
